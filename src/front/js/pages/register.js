					...
					<div className="container px-5">
						<form id="contactForm ">
							...
							<div className="mb-3 mx-auto " style={{ maxWidth: '427x', height: 'auto' }}>
								<input value={formValues.password} onChange={(e) => setFormValues({ ...formValues, password: e.target.value })} className="form-control" id="password" type="password" placeholder="Password" data-sb-validations="required" />
